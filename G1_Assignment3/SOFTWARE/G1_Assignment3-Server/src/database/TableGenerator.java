...
//			generateProductInRequest(con);
	...
	private static void generateActivity(Connection con) throws SQLException {
		...
		String values = "( " + " activityID int NOT NULL AUTO_INCREMENT ," + " FK_employeeID INT NOT NULL ,"
				+ " time TIMESTAMP NOT NULL ," + " action varchar(500) NOT NULL ," + " PRIMARY KEY (activityID) ,"
				// fk1
	...
	private static void generateCar(Connection con) throws SQLException {
		...
		String values = "( " + " registrationPlate varchar(50) NOT NULL ," + " FK_customerID varchar(50) NOT NULL ,"
				+ " FK_productName varchar(50) NOT NULL ," + " ownerName varchar(500) NOT NULL ,"
	...
	private static void generateCustomer(Connection con) throws SQLException {
		...
		String values = "( " + " customerID varchar(50) NOT NULL ," + " FK_username varchar(50) NOT NULL UNIQUE ,"
				+ " creditCard varchar(20) NOT NULL ," + " customerType varchar(50) NOT NULL ,"
	...
	private static void generateCustomerBoughtFromCompany(Connection con) throws SQLException {
		...
		String values = "( " + " FK_customerID varchar(50) NOT NULL ," + " FK_fuelCompanyName varchar(50) NOT NULL ,"
	...
	private static void generateCustomerBoughtInSale(Connection con) throws SQLException {
		...
		String values = "( " + " FK_saleID INT NOT NULL ," + " FK_customerID varchar(50) NOT NULL ,"
	...
	private static void generateEmployee(Connection con) throws SQLException {
		...
		String values = "( " + " employeeID int NOT NULL AUTO_INCREMENT ,"
				+ " FK_userName varchar(50) NOT NULL UNIQUE ," + " role varchar(50) NOT NULL ,"
				+ " affiliation varchar(50) NOT NULL ," + " PRIMARY KEY (employeeID) ,"
				// fk1
	...
	private static void generateFastFuel(Connection con) throws SQLException {
		...
		String values = "( " + " fastFuelID INT NOT NULL AUTO_INCREMENT ,"
				+ " FK_registrationPlate varchar(50) NOT NULL ," + " FK_customerID varchar(50) NOT NULL ,"
	...
	private static void generateFuelCompany(Connection con) throws SQLException {
		...
		String values = "( " + " fuelCompanyName varchar(50) NOT NULL ," + " FK_employeeID int NOT NULL ," // supplier
	...
	private static void generateFuelStation(Connection con) throws SQLException {
		...
		String values = "( " + " fuelStationID INT NOT NULL AUTO_INCREMENT ,"
				+ " FK_fuelCompanyName varchar(50) NOT NULL ," + " FK_employeeID INT NOT NULL UNIQUE ,"
				+ " stationName varchar(500) NOT NULL UNIQUE ," + " address varchar(500) NOT NULL ,"
	...
	private static void generateFuelStationManager(Connection con) throws SQLException {
		...
		String values = "( " + " FK_employeeID int NOT NULL ," + " phoneNo varchar(50) NOT NULL ,"
	...
	private static void generateFuelStationOrder(Connection con) throws SQLException {
		...
		String values = "( " + "FK_ordersID INT NOT NULL ," + "FK_productInStationID INT NOT NULL ,"
				+ "assessed varchar(1) NOT NULL ," + "approved varchar(1) ," + "reasonDismissal varchar(500) ,"
	...
	private static void generateHomeFuelOrder(Connection con) throws SQLException {
		...
		String values = "( " + " FK_ordersID int NOT NULL ," + " FK_customerID varchar(50) NOT NULL ,"
				+ " FK_product_Name varchar(50) NOT NULL ," + " FK_shipmentType varchar(50) NOT NULL ,"
	...
	private static void generateIncomeReport(Connection con) throws SQLException {
		...
		String values = "( " + " FK_repQuarter INT NOT NULL," + " FK_repYear varchar(50) NOT NULL ,"
	...
	private static void generateNotification(Connection con) throws SQLException {
		...
		String values = "( " + " notificationID int NOT NULL AUTO_INCREMENT ," + " FK_employeeID int NOT NULL ,"
				+ " message varchar(500) NOT NULL ," + " dismissed varchar(1) NOT NULL ,"
	...
	private static void generateOrders(Connection con) throws SQLException {
		...
		String values = "( " + " ordersID int NOT NULL AUTO_INCREMENT ," + " orderTime TIMESTAMP NOT NULL ,"
				+ " amountBought DOUBLE(32,2) NOT NULL ," + " address varchar(500) NOT NULL ,"
	...
	private static void generatePricingModel(Connection con) throws SQLException {
		...
		String values = "( " + " FK_customerID varchar(50) NOT NULL ," + " FK_pricingModelName varchar(50) NOT NULL ,"
	...
	private static void generatePricingModelType(Connection con) throws SQLException {
		...
		String values = "( " + " pricingModelName varchar(50) NOT NULL ," + " description varchar(500) NOT NULL ,"
	...
	private static void generateProduct(Connection con) throws SQLException {
		...
		String values = "( " + " productName varchar(50) NOT NULL ," + " maxPrice DOUBLE(32,2) NOT NULL ,"
	...
	private static void generateProductInIncomeReport(Connection con) throws SQLException {
		...
		String values = "( " + " FK_productInStationID INT NOT NULL ," + " FK_repQuarter_IncomeReport INT NOT NULL ,"
				+ " FK_repYear_IncomeReport varchar(50) NOT NULL ," + " incomePerProduct DOUBLE(32,2) NOT NULL ,"
	...
	private static void generateProductInInventoryReport(Connection con) throws SQLException {
		...
		String values = "( " + " FK_productInStationID INT NOT NULL ," + " FK_repQuarter_inventoryReport INT NOT NULL ,"
				+ " FK_repYear_inventoryReport varchar(50) NOT NULL ," + " amountSold DOUBLE(32,2) NOT NULL ,"
...
//		String values = "( " + " FK_updateRateRequestID INT NOT NULL ," + " FK_productName varchar(50) NOT NULL ,"
...
//	}
	...
	private static void generateProductInSalesPattern(Connection con) throws SQLException {
		...
		String values = "( " + " FK_salesPatternID INT NOT NULL ," + " FK_productName varchar(50) NOT NULL ,"
	...
	private static void generateProductInStation(Connection con) throws SQLException {
		...
		String values = "( " + " productInStationID INT NOT NULL AUTO_INCREMENT ,"
				+ " FK_productName varchar(50) NOT NULL ," + " FK_fuelStationID INT NOT NULL ,"
...
//	}
	...
	private static void generatePurchasingProgram(Connection con) throws SQLException {
		...
		String values = "( " + " FK_customerID varchar(50) NOT NULL ,"
				+ " FK_purchasingProgramName varchar(50) NOT NULL ," + " FK_fuelCompanyName1 varchar(50) NOT NULL ,"
				+ " FK_fuelCompanyName2 varchar(50) ," + " FK_fuelCompanyName3 varchar(50) ,"
				+ " PRIMARY KEY (FK_customerID) ,"
				// fk1
	...
	private static void generatePurchasingProgramType(Connection con) throws SQLException {
		...
		String values = "( " + " purchasingProgramName varchar(50) NOT NULL ," + " description varchar(500) NOT NULL ,"
	...
	private static void generateQuarterlyReport(Connection con) throws SQLException {
		...
		String values = "( " + " repQuarter INT NOT NULL ," + " repYear varchar(50) NOT NULL ,"
	...
	private static void generateRankingSheet(Connection con) throws SQLException {
		...
		String values = "( " + " FK_customerID varchar(50) NOT NULL ," + " customerTypeRank DOUBLE(32,2) NOT NULL ,"
	...
	private static void generateShipmentMethod(Connection con) throws SQLException {
		...
		String values = "( " + " shipmentType varchar(50) NOT NULL ," + " shipmentPrice DOUBLE(32,2) NOT NULL ,"
				+ " shipmentMultiplier DOUBLE(32,2) NOT NULL ," + " deliveryTime varchar(500) NOT NULL ,"
	...
	private static void generateUser(Connection con) throws SQLException {
		...
		String values = "( " + " username varchar(50) NOT NULL ," + " password varchar(50) NOT NULL ,"
				+ " connected varchar(1) NOT NULL ," + " email varchar(64) NOT NULL ,"
				+ " firstName varchar(50) NOT NULL ," + " surname varchar(50) NOT NULL ," + " PRIMARY KEY (username) )";
		generateTable(con, tableName, values);
	}
	/**
	 * 
	...
	private static void generatePricingModelUpdateRequest(Connection con) throws SQLException {
		...
		String values = "( " + " requestID INT NOT NULL AUTO_INCREMENT ," + " FK_pricingModelName varchar(50) ,"
